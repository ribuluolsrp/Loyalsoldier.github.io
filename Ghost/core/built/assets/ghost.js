        ...
        actions: {
            ...
            setPublishedAt: function setPublishedAt(userInput) {
                ...
                if (!newPublishedAt.isValid()) {
                    errMessage = "错误的日期格式: " + "YYYY年MM月DD日 @ HH:mm (例如：2014年10月8日 @ 20:00 )";
                }
        ...
        actions: {
            ...
            save: function save() {
                var self = this,
                    ...
                    message = "您至少需要保存一项导航菜单。 " + "<br /> 请在保存前，填写好导航菜单。",
                    match;
    ...
    var User = DS['default'].Model.extend(NProgressSaveMixin['default'], SelectiveSaveMixin['default'], ValidationEngine['default'], {
        ...
        passwordValidationErrors: Ember['default'].computed("password", "newPassword", "ne2Password", function () {
            ...
            if (!validator.isLength(this.get("newPassword"), 8)) {
                validationErrors.push({ message: "密码太短了。请至少输入8位密码。" });
            }
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("a");
        dom.setAttribute(el2,"href","https://github.com/imShadow");
        dom.setAttribute(el2,"title","imShadow");
        var el3 = dom.createTextNode("\n        ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("img");
        dom.setAttribute(el3,"alt","imShadow");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n    ");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
      ...
      render: function render(context, env, contextualElement) {
        ...
        attribute(env, attrMorph3, element3, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/imShadow"]));
        attribute(env, attrMorph4, element4, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/halfdan"]));
        attribute(env, attrMorph5, element5, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/novaugust"]));
        attribute(env, attrMorph6, element6, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/dbalders"]));
        attribute(env, attrMorph7, element7, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/chilts"]));
        attribute(env, attrMorph8, element8, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/nsfmc"]));
        attribute(env, attrMorph9, element9, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/felixrieseberg"]));
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child3 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          var el3 = dom.createTextNode("账号设置");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n            ");
          dom.appendChild(el1, el2);
        ...
        render: function render(context, env, contextualElement) {
          ...
          attribute(env, attrMorph0, element1, "style", get(env, context, "userImageBackground"));
          attribute(env, attrMorph1, element2, "src", get(env, context, "userImage"));
          attribute(env, attrMorph2, element2, "title", get(env, context, "userImageAlt"));
    ...
    var child6 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          dom.setAttribute(el3,"href","https://diancloud.com");
          dom.setAttribute(el3,"target","_blank");
          var el4 = dom.createElement("i");
          dom.setAttribute(el4,"class","icon-link");
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode(" 点云DianCloud ");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n\n                ");
          ...
          dom.setAttribute(el3,"role","menuitem");
          dom.setAttribute(el3,"tabindex","-1");
          dom.setAttribute(el3,"href","https://diancloud.com/apps");
          var el4 = dom.createTextNode(" ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("i");
          dom.setAttribute(el4,"class","icon-weather-cloudy");
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode(" 云应用商店 ");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n\n                ");
          ...
          dom.setAttribute(el3,"role","menuitem");
          dom.setAttribute(el3,"tabindex","-1");
          dom.setAttribute(el3,"href","http://ghost.diancloud.com/doc/zh/usage/");
          dom.setAttribute(el3,"target","_blank");
          var el4 = dom.createElement("i");
          dom.setAttribute(el4,"class","icon-book");
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode(" 使用手册 ");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n\n                ");
          ...
          dom.setAttribute(el2,"role","presentation");
          var el3 = dom.createElement("a");
          dom.setAttribute(el3,"href","http://shang.qq.com/wpa/qunwpa?idkey=eb5bc8f9f7444caa1bbdd77c4422b71f6cbda70c21a43f5253653d930c33ea7e");
          dom.setAttribute(el3,"target","_blank");
          var el4 = dom.createTextNode(" ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("i");
          dom.setAttribute(el4,"class","icon-users");
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode(" QQ群 335978388 ");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          var el3 = dom.createTextNode(" ");
          dom.appendChild(el2, el3);
    ...
    return {
      ...
      build: function build(dom) {
        ...
        var el5 = dom.createTextNode("访问博客");
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph6 = dom.createMorphAt(element6,2,2);
    ...
    var child0 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          var el3 = dom.createTextNode("设置为所有者");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n");
    ...
    var child1 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          var el3 = dom.createTextNode("删除这个用户");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n");
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        inline(env, morph1, context, "gh-trim-focus-input", [], {"focus": get(env, context, "navItem.last"), "placeholder": "名称", "value": get(env, context, "navItem.label")});
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        var el2 = dom.createElement("span");
        dom.setAttribute(el2,"class","hidden");
        var el3 = dom.createTextNode("单击添加图片");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        var el5 = dom.createTextNode("MARKDOWN 标签");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n            ");
        dom.appendChild(el3, el4);
        ...
        var el6 = dom.createTextNode("Markdown使用帮助");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      build: function build(dom) {
        ...
        var el5 = dom.createTextNode("登录管理后台 →");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n         ");
        dom.appendChild(el3, el4);
      ...
      render: function render(context, env, contextualElement) {
        ...
        attribute(env, attrMorph2, element5, "href", concat(env, [subexpr(env, context, "gh-path", ["blog"], {}), "/ghost/"]));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          var el2 = dom.createTextNode("博文一旦删除可能将无法恢复，请陛下三思。  ");
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("br");
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("  真的要删除吗?");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n\n");
          dom.appendChild(el0, el1);
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        dom.insertBoundary(fragment, null);
        dom.insertBoundary(fragment, 0);
        block(env, morph0, context, "gh-modal-dialog", [], {"action": "closeModal", "type": "action", "style": "wide", "title": "真的要删除所有博文吗?", "confirm": get(env, context, "confirm")}, child0, null);
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        dom.insertBoundary(fragment, null);
        dom.insertBoundary(fragment, 0);
        block(env, morph0, context, "gh-modal-dialog", [], {"action": "closeModal", "showClose": true, "type": "action", "style": "wide", "title": "真的要删除这篇博文吗?", "confirm": get(env, context, "confirm")}, child0, null);
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            var el2 = dom.createTextNode("这个标签被 ");
            dom.appendChild(el1, el2);
            var el2 = dom.createComment("");
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode(" ");
            ...
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\" 标签. 此操作不可恢复，请确认。\n");
            dom.appendChild(el0, el1);
            return el0;
          },
          render: function render(context, env, contextualElement) {
      ...
      var child1 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode(" 你将删除 \"");
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("strong");
            var el2 = dom.createComment("");
            dom.appendChild(el1, el2);
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        dom.insertBoundary(fragment, null);
        dom.insertBoundary(fragment, 0);
        block(env, morph0, context, "gh-modal-dialog", [], {"action": "closeModal", "showClose": true, "type": "action", "style": "wide", "title": "请确认删除这个标签?", "confirm": get(env, context, "confirm")}, child0, null);
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
        ...
        var child0 = (function() {
          return {
            ...
            build: function build(dom) {
              ...
              dom.appendChild(el1, el2);
              dom.appendChild(el0, el1);
              var el1 = dom.createTextNode("该用户发表的博文( ");
              dom.appendChild(el0, el1);
              var el1 = dom.createElement("span");
              dom.setAttribute(el1,"class","red");
              var el2 = dom.createComment("");
              ...
              dom.appendChild(el1, el2);
              dom.appendChild(el0, el1);
              var el1 = dom.createTextNode(" )等信息将一起被删除。 这些数据将无法恢复。\n");
              dom.appendChild(el0, el1);
              return el0;
            },
            render: function render(context, env, contextualElement) {
        ...
        var child1 = (function() {
          return {
            ...
            build: function build(dom) {
              ...
              dom.appendChild(el1, el2);
              dom.appendChild(el0, el1);
              var el1 = dom.createTextNode(" 该用户发表的博文等信息将一起被删除。 这些数据将无法恢复。\n");
              dom.appendChild(el0, el1);
              return el0;
            },
            render: function render(context, env, contextualElement) {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph0 = dom.createMorphAt(fragment,1,1,contextualElement);
        dom.insertBoundary(fragment, null);
        block(env, morph0, context, "gh-modal-dialog", [], {"action": "closeModal", "showClose": true, "type": "action", "style": "wide", "title": "真的要删除这个用户吗？", "confirm": get(env, context, "confirm")}, child0, null);
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph0 = dom.createMorphAt(fragment,1,1,contextualElement);
        dom.insertBoundary(fragment, null);
        block(env, morph0, context, "gh-modal-dialog", [], {"action": "closeModal", "showClose": true, "type": "action", "title": "邀请用户", "confirm": get(env, context, "confirm"), "class": "invite-new-user"}, child0, null);
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("p");
          var el2 = dom.createTextNode("刚刚做的修改还没有保存呢。");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n\n    ");
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("p");
          var el2 = dom.createTextNode("建议保存后离开!");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n\n");
          dom.appendChild(el0, el1);
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph0 = dom.createMorphAt(fragment,1,1,contextualElement);
        dom.insertBoundary(fragment, null);
        block(env, morph0, context, "gh-modal-dialog", [], {"action": "closeModal", "showClose": true, "type": "action", "style": "wide", "title": "真的要离开这个页面吗？", "confirm": get(env, context, "confirm")}, child0, null);
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          var el6 = dom.createTextNode("说明/演示");
          dom.appendChild(el5, el6);
          dom.appendChild(el4, el5);
          var el5 = dom.createTextNode("\n                ");
          dom.appendChild(el4, el5);
          var el5 = dom.createElement("th");
          var el6 = dom.createTextNode("标签");
          dom.appendChild(el5, el6);
          dom.appendChild(el4, el5);
          var el5 = dom.createTextNode("\n                ");
          dom.appendChild(el4, el5);
          ...
          var el7 = dom.createTextNode("单行代码");
          dom.appendChild(el6, el7);
          dom.appendChild(el5, el6);
          dom.appendChild(el4, el5);
          var el5 = dom.createTextNode("\n                ");
          ...
          var el7 = dom.createTextNode("高亮显示");
          dom.appendChild(el6, el7);
          dom.appendChild(el5, el6);
          dom.appendChild(el4, el5);
          var el5 = dom.createTextNode("\n                ");
          ...
          var el3 = dom.createTextNode("Markdown官网");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n    ");
          dom.appendChild(el1, el2);
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph0 = dom.createMorphAt(fragment,1,1,contextualElement);
        dom.insertBoundary(fragment, null);
        block(env, morph0, context, "gh-modal-dialog", [], {"action": "closeModal", "showClose": true, "style": "wide", "title": "Markdown标签速查"}, child0, null);
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("p");
          var el2 = dom.createTextNode("真的要将博客转让吗? 这个操作不可恢复。");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n\n");
          dom.appendChild(el0, el1);
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph0 = dom.createMorphAt(fragment,1,1,contextualElement);
        dom.insertBoundary(fragment, null);
        block(env, morph0, context, "gh-modal-dialog", [], {"action": "closeModal", "showClose": true, "type": "action", "style": "wide", "title": "转让所有权", "confirm": get(env, context, "confirm")}, child0, null);
        return fragment;
      }
    };
  }()));
    ...
    var child0 = (function() {
        ...
        var child0 = (function() {
          return {
            ...
            build: function build(dom) {
              ...
              var el5 = dom.createTextNode("呈现标题");
              dom.appendChild(el4, el5);
              dom.appendChild(el3, el4);
              var el4 = dom.createTextNode("\n                ");
              dom.appendChild(el3, el4);
              ...
              dom.appendChild(el5, el6);
              dom.appendChild(el4, el5);
              var el5 = dom.createTextNode(" 字以内效果最佳。 已输入 ");
              dom.appendChild(el4, el5);
              var el5 = dom.createComment("");
              dom.appendChild(el4, el5);
              var el5 = dom.createTextNode(" 个字");
              dom.appendChild(el4, el5);
              dom.appendChild(el3, el4);
              var el4 = dom.createTextNode("\n            ");
              dom.appendChild(el3, el4);
              ...
              var el5 = dom.createTextNode("呈现摘要");
              dom.appendChild(el4, el5);
              dom.appendChild(el3, el4);
              var el4 = dom.createTextNode("\n                ");
              dom.appendChild(el3, el4);
            ...
            render: function render(context, env, contextualElement) {
              ...
              inline(env, morph1, context, "gh-count-down-characters", [get(env, context, "metaTitleScratch"), 15], {});
              ...
              inline(env, morph3, context, "gh-count-down-characters", [get(env, context, "metaDescriptionScratch"), 80], {});
              content(env, morph4, context, "seoTitle");
              content(env, morph5, context, "seoDescription");
              content(env, morph6, context, "seoURL");
              return fragment;
            }
          };
        }());
      ...
      return {
        ...
        build: function build(dom) {
          ...
          var el5 = dom.createTextNode("博文选项");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n            ");
          dom.appendChild(el3, el4);
          ...
          var el7 = dom.createTextNode("发布时间");
          dom.appendChild(el6, el7);
          dom.appendChild(el5, el6);
          var el6 = dom.createTextNode("\n                ");
          dom.appendChild(el5, el6);
          ...
          var el8 = dom.createTextNode("作为独立页面(不出现在博文列表)");
          ...
          dom.appendChild(el6, el7);
          var el7 = dom.createElement("p");
          var el8 = dom.createTextNode("这是特殊页面(部分主题呈现样式不同)");
          dom.appendChild(el7, el8);
          dom.appendChild(el6, el7);
          var el7 = dom.createTextNode("\n                ");
          dom.appendChild(el6, el7);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      build: function build(dom) {
        ...
        var el2 = dom.createElement("h2");
        dom.setAttribute(el2,"class","page-title");
        var el3 = dom.createTextNode("博文列表");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
    ...
    var child0 = (function() {
      ...
      return {
        ...
        build: function build(dom) {
          ...
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("h3");
          var el3 = dom.createTextNode("没有博文，赶快创作吧！");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n    ");
          dom.appendChild(el1, el2);
    ...
    var child1 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("a");
          var el2 = dom.createTextNode("已发布");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n");
          dom.appendChild(el0, el1);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        inline(env, morph1, context, "input", [], {"value": get(env, context, "ne2Password"), "class": "password", "type": "password", "placeholder": "再输入一遍密码", "name": "ne2password"});
        attribute(env, attrMorph0, element1, "disabled", get(env, context, "submitting"));
        return fragment;
      }
    };
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          var morph0 = dom.createMorphAt(fragment,1,1,contextualElement);
          inline(env, morph0, context, "gh-activating-list-item", [], {"route": "settings.general", "title": "博客选项", "classNames": "settings-nav-general icon-settings"});
          return fragment;
        }
      };
    }());
    ...
    var child3 = (function() {
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          var morph0 = dom.createMorphAt(fragment,1,1,contextualElement);
          inline(env, morph0, context, "gh-activating-list-item", [], {"route": "settings.navigation", "title": "博客导航", "classNames": "settings-nav-navigation icon-compass"});
          return fragment;
        }
      };
    }());
    var child4 = (function() {
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          var morph0 = dom.createMorphAt(fragment,1,1,contextualElement);
          inline(env, morph0, context, "gh-activating-list-item", [], {"route": "settings.code-injection", "title": "自定义代码", "classNames": "settings-nav-code icon-code"});
          return fragment;
        }
      };
    }());
    ...
    return {
      ...
      build: function build(dom) {
        ...
        var el2 = dom.createElement("h2");
        dom.setAttribute(el2,"class","page-title");
        var el3 = dom.createTextNode("博客设置");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child1 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("p");
          var el2 = dom.createTextNode("简约、纯粹的独立博客平台");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n");
          dom.appendChild(el0, el1);
    ...
    return {
      ...
      build: function build(dom) {
        ...
        dom.setAttribute(el5,"href","http://ghost.diancloud.com/?f=ghost-about");
        dom.setAttribute(el5,"target","_blank");
        dom.setAttribute(el5,"class","btn");
        var el6 = dom.createTextNode("中文官网");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n                ");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("a");
        dom.setAttribute(el5,"href","https://www.ghost.org/");
        dom.setAttribute(el5,"target","_blank");
        dom.setAttribute(el5,"class","btn");
        var el6 = dom.createTextNode("官方网站");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("h1");
        var el4 = dom.createTextNode("Ghost开发者");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n        ");
        dom.appendChild(el2, el3);
        ...
        var el4 = dom.createTextNode("Ghost的开发者来自全球各地，这里列出的是参与Ghost中文版的主要开发者。");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n    ");
        dom.appendChild(el2, el3);
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("h1");
        var el4 = dom.createTextNode("中文本地化团队");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n       \n        ");
        dom.appendChild(el2, el3);
        ...
        dom.setAttribute(el4,"href","http://ghost.diancloud.com/?f=ghost-about");
        dom.setAttribute(el4,"title","点云-精品云应用");
        var el5 = dom.createElement("img");
        dom.setAttribute(el5,"src","http://diancloud-ghost.stor.sinaapp.com/logo-90.png");
        dom.setAttribute(el5,"width","258");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode(" \n        ");
        dom.appendChild(el3, el4);
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("p");
        var el4 = dom.createTextNode("Ghost由 “点云开源软件字幕组” 翻译。 ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("strong");
        var el5 = dom.createTextNode(" 如真的给你带来便利，");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("a");
        dom.setAttribute(el5,"href","https://github.com/diancloud/Ghost");
        dom.setAttribute(el5,"target","_blank");
        var el6 = dom.createTextNode("求到GitHub加星");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode(" 鼓励我们一下 ^_^ ");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode(" ");
        dom.appendChild(el3, el4);
        ...
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("strong");
        var el5 = dom.createTextNode("335978388");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("， 技术支持邮箱: ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("strong");
        var el5 = dom.createTextNode("support@diancloud.com");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode(" 。");
        dom.appendChild(el3, el4);
        ...
        dom.setAttribute(el4,"title","点云-精品云应用");
        var el5 = dom.createElement("img");
        dom.setAttribute(el5,"src","http://diancloud-ghost.stor.sinaapp.com/qrcode_for_wx.jpg");
        dom.setAttribute(el5,"width","258");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode(" ");
        ...
        var el4 = dom.createElement("a");
        dom.setAttribute(el4,"target","_blank");
        dom.setAttribute(el4,"href","http://weibo.com/diancloud");
        dom.setAttribute(el4,"title","点云-精品云应用");
        var el5 = dom.createElement("img");
        dom.setAttribute(el5,"src","http://service.t.sina.com.cn/widget/qmd/5285987604/5ff50740/4.png");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("br");
        dom.appendChild(el3, el4);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      build: function build(dom) {
        ...
        var el2 = dom.createElement("h2");
        dom.setAttribute(el2,"class","page-title");
        var el3 = dom.createTextNode("自定义代码");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n    ");
        dom.appendChild(el1, el2);
        ...
        var el6 = dom.createTextNode("网页头部");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n                ");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("p");
        var el6 = dom.createTextNode("这段代码使用模板标签 ");
        dom.appendChild(el5, el6);
        var el6 = dom.createElement("code");
        ...
        var el6 = dom.createTextNode("网页尾部");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n                ");
        dom.appendChild(el4, el5);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child5 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("p");
          var el3 = dom.createTextNode("访问者需要输入上面的暗号才能访问您的博客(暗号支持中文)。开启后您的博客将无法被搜索引擎收录。");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n            ");
          dom.appendChild(el1, el2);
    ...
    return {
      ...
      build: function build(dom) {
        ...
        var el2 = dom.createElement("h2");
        dom.setAttribute(el2,"class","page-title");
        var el3 = dom.createTextNode("博客选项");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n    ");
        dom.appendChild(el1, el2);
        ...
        dom.setAttribute(el3,"type","button");
        dom.setAttribute(el3,"class","btn btn-blue");
        var el4 = dom.createTextNode("保存设置");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n    ");
        dom.appendChild(el2, el3);
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("p");
        var el6 = dom.createTextNode("为你的博客取一个好听的名字");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
        ...
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("p");
        var el5 = dom.createTextNode("上传一个漂亮的LOGO，秀出你的品牌");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        dom.appendChild(el3, el4);
        ...
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("p");
        var el5 = dom.createTextNode("有封面的博客最酷，添加一个吧。");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        dom.appendChild(el3, el4);
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("p");
        var el6 = dom.createTextNode("用来接收Ghost博客发出的重要通知");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
        ...
        var el6 = dom.createTextNode("每页显示博文");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n\n                ");
        dom.appendChild(el4, el5);
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("p");
        var el6 = dom.createTextNode("设置每页显示博文数量。");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
        ...
        var el7 = dom.createTextNode("在博文地址中显示日期 ( 选中示例: http://yourblog.com/2014/10/11/hello/ )");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n                ");
        dom.appendChild(el5, el6);
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("p");
        var el6 = dom.createTextNode("选择一个你喜欢的博客主题");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
        ...
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("div");
        dom.setAttribute(el4,"class","form-group sitemap-container");
        var el5 = dom.createTextNode("\n                ");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("label");
        dom.setAttribute(el5,"for","blog-sitemap");
        var el6 = dom.createTextNode("站点地图");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n                ");
        dom.appendChild(el4, el5);
        ...
        dom.appendChild(el5, el6);
        var el6 = dom.createElement("a");
        dom.setAttribute(el6,"href","/sitemap.xml");
        dom.setAttribute(el6,"target","_blank");
        var el7 = dom.createTextNode("查看站点地图");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        ...
        var el6 = dom.createTextNode("隐私设置");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n                ");
        dom.appendChild(el4, el5);
        ...
        dom.appendChild(el5, el6);
        var el6 = dom.createElement("p");
        var el7 = dom.createTextNode("设置访问暗号");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n                ");
        dom.appendChild(el5, el6);
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph10 = dom.createMorphAt(dom.childAt(element9, [11, 3]),1,1);
        var morph11 = dom.createMorphAt(element9,13,13);
        block(env, morph0, context, "link-to", ["settings"], {"class": "btn btn-default btn-back"}, child0, null);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child1 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          dom.appendChild(el2, el3);
          var el3 = dom.createElement("label");
          var el4 = dom.createTextNode("数据导入");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          var el3 = dom.createTextNode("\n                ");
          dom.appendChild(el2, el3);
          ...
          dom.appendChild(el2, el3);
          var el3 = dom.createElement("p");
          var el4 = dom.createTextNode("导入博客配置和博文数据。注意：如导入数据中包含用户信息，用户信息会被覆盖，你可能将无法登录。");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          var el3 = dom.createTextNode("\n            ");
          dom.appendChild(el2, el3);
    ...
    return {
      ...
      build: function build(dom) {
        ...
        var el2 = dom.createElement("p");
        var el3 = dom.createElement("strong");
        var el4 = dom.createTextNode("点云DianCloud 提醒您:");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode(" 这里列出的功能均为实验性的，请慎重使用。随着版本更新，这些功能特性可能会有所调整。");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n\n    ");
        dom.appendChild(el1, el2);
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("label");
        var el6 = dom.createTextNode("数据导出");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n                ");
        dom.appendChild(el4, el5);
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("p");
        var el6 = dom.createTextNode("导出博客配置和博文数据。");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      build: function build(dom) {
        ...
        var el2 = dom.createElement("h2");
        dom.setAttribute(el2,"class","page-title");
        var el3 = dom.createTextNode("博客导航");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n    ");
        dom.appendChild(el1, el2);
    ...
    var child0 = (function() {
      ...
      var child2 = (function() {
        return {
          ...
          render: function render(context, env, contextualElement) {
            ...
            inline(env, morph1, context, "gh-count-down-characters", [get(env, context, "activeTagMetaTitleScratch"), 15], {});
            ...
            inline(env, morph3, context, "gh-count-down-characters", [get(env, context, "activeTagMetaDescriptionScratch"), 80], {});
            content(env, morph4, context, "seoTitle");
            content(env, morph5, context, "seoDescription");
            content(env, morph6, context, "seoURL");
            return fragment;
      ...
      return {
        ...
        build: function build(dom) {
          ...
          var el4 = dom.createTextNode("标签管理");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          var el3 = dom.createTextNode("\n            ");
          dom.appendChild(el2, el3);
    ...
    var child0 = (function() {
      ...
      var child2 = (function() {
          ...
          var child0 = (function() {
            return {
              ...
              build: function build(dom) {
                ...
                var el1 = dom.createElement("span");
                dom.setAttribute(el1,"class","red");
                var el2 = dom.createTextNode("邀请发送失败 - 请重试");
                dom.appendChild(el1, el2);
                dom.appendChild(el0, el1);
                var el1 = dom.createTextNode("\n");
                dom.appendChild(el0, el1);
          ...
          var child1 = (function() {
            return {
              ...
              build: function build(dom) {
                ...
                var el1 = dom.createElement("span");
                dom.setAttribute(el1,"class","description");
                var el2 = dom.createTextNode("邀请已发送: ");
                dom.appendChild(el1, el2);
                var el2 = dom.createComment("");
                dom.appendChild(el1, el2);
                dom.appendChild(el0, el1);
        ...
        return {
          ...
          build: function build(dom) {
            ...
            var el3 = dom.createTextNode("已邀请用户");
            dom.appendChild(el2, el3);
            dom.appendChild(el1, el2);
            var el2 = dom.createTextNode("\n\n");
            dom.appendChild(el1, el2);
      ...
      return {
        ...
        build: function build(dom) {
          ...
          var el3 = dom.createElement("button");
          dom.setAttribute(el3,"class","btn btn-green");
          var el4 = dom.createTextNode("邀请用户");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          var el3 = dom.createTextNode("\n        ");
          dom.appendChild(el2, el3);
          ...
          var el4 = dom.createTextNode("已注册用户");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          var el3 = dom.createTextNode("\n\n\n");
          dom.appendChild(el2, el3);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
      ...
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            var el1 = dom.createElement("span");
            dom.setAttribute(el1,"class","hidden");
            var el2 = dom.createTextNode("资料设置");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n");
            dom.appendChild(el0, el1);
    ...
    var child2 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("p");
          var el3 = dom.createTextNode("选择用户角色, 不同角色拥有不同权限");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n            ");
          dom.appendChild(el1, el2);
    ...
    return {
      ...
      build: function build(dom) {
        ...
        var el3 = dom.createElement("button");
        dom.setAttribute(el3,"class","btn btn-blue");
        var el4 = dom.createTextNode("保存资料");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n    ");
        dom.appendChild(el2, el3);
        ...
        var el6 = dom.createTextNode("修改头像");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
        ...
        var el6 = dom.createTextNode("姓名/昵称");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n                ");
        dom.appendChild(el4, el5);
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("p");
        var el6 = dom.createTextNode("在你发表文章时，会用这个名字作为签名");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
        ...
        var el6 = dom.createTextNode("主页地址");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n                ");
        dom.appendChild(el4, el5);
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("p");
        var el6 = dom.createTextNode("用来登录博客后台和接收重要通知");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("p");
        var el6 = dom.createTextNode("也可以填写你的微博地址");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
      ...
      render: function render(context, env, contextualElement) {
        ...
        inline(env, morph4, context, "input", [], {"value": get(env, context, "user.name"), "id": "user-name", "class": "user-name", "placeholder": "姓名/昵称", "autocorrect": "off"});
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        var el6 = dom.createTextNode("第一次使用你的Ghost博客");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n                ");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("h2");
        var el6 = dom.createTextNode("请填写下面的表单，即可开启Ghost博客");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("p");
        var el6 = dom.createTextNode("设置一个密码，至少要8个字符");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("p");
        dom.setAttribute(el5,"style","margin-top:10px;text-align:center");
        var el6 = dom.createTextNode("( 首次开启可能需要近1分钟的时间, 请不要关闭或刷新页面 ) ");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        var el5 = dom.createTextNode("找回密码");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        dom.appendChild(el3, el4);
      ...
      render: function render(context, env, contextualElement) {
        ...
        var attrMorph0 = dom.createAttrMorph(element1, 'disabled');
        element(env, element0, context, "action", ["validateAndAuthenticate"], {"on": "submit"});
        inline(env, morph0, context, "gh-trim-focus-input", [], {"class": "email", "type": "email", "placeholder": "邮箱", "name": "identification", "autocapitalize": "off", "autocorrect": "off", "value": get(env, context, "model.identification")});
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("h1");
        var el6 = dom.createTextNode("欢迎使用Ghost博客");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n                ");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("h2");
        var el6 = dom.createTextNode("请填写下面表单，完成注册。");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("p");
        var el6 = dom.createTextNode("设置一个登录密码，至少要8个字符");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
        ...
        dom.setAttribute(el5,"type","submit");
        dom.setAttribute(el5,"class","btn btn-green btn-lg");
        var el6 = dom.createTextNode("创建账号");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
...
if (runningTests) {
  ...
  require("ghost/app")["default"].create({"LOG_ACTIVE_GENERATION":true,"LOG_TRANSITIONS":true,"LOG_TRANSITIONS_INTERNAL":true,"LOG_VIEW_LOOKUPS":true,"name":"ghost","version":"0.0.0.c46cce63"});
}
